...
df = pd.read_csv(r'C:\Users\shruti shreya\monitor_env\Crop_details.csv')
print(df.head(2))
...
Train_Data1 = Data.flow_from_directory(r'./kag2', target_size=(224, 224), batch_size=1)
Train_Data2 = Data.flow_from_directory(r'./crop_images', target_size=(224, 224), batch_size=1)
Test_Data = Data.flow_from_directory(r'./some_more_images', target_size=(224, 224), batch_size=1)
...
CNN_Model.fit(Train_Data1, epochs=50)

CNN_Model.evaluate(Train_Data1)
CNN_Model.evaluate(Train_Data2)
